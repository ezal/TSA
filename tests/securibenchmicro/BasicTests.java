...
public class BasicTests extends JUnitTests {
	...
	@Test public void basic14() {oneRun("securibench.micro.basic.Basic14", "doGet", TSA.FAILURE);}	
	...
	@Test public void basic21() {oneRun("securibench.micro.basic.Basic21", "doGet", TSA.FAILURE);}
	...
	@Test public void basic25() {oneRun("securibench.micro.basic.Basic25", "doGet", TSA.FAILURE);}
	@Test public void basic26() {oneRun("securibench.micro.basic.Basic26", "doGet", TSA.FAILURE);}
	...
	@Test public void basic31() {oneRun("securibench.micro.basic.Basic31", "doGet", TSA.FAILURE);}
	@Test public void basic32() {oneRun("securibench.micro.basic.Basic32", "doGet", TSA.FAILURE);}
	@Test public void basic33() {oneRun("securibench.micro.basic.Basic33", "doGet", TSA.FAILURE);}
	@Test public void basic34() {oneRun("securibench.micro.basic.Basic34", "doGet", TSA.FAILURE);}
	@Test public void basic35() {oneRun("securibench.micro.basic.Basic35", "doGet", TSA.FAILURE);}
	@Test public void basic36() {oneRun("securibench.micro.basic.Basic36", "doGet", TSA.FAILURE);}
